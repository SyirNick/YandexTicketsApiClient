...
{
    /// <summary>
    /// Класс запроса изменения статуса заказа на "продан".
    /// </summary>
    public class SetOrderSoldRequest : TicketOperationRequestBase
    {
        /// <summary>
        /// Конструктор класса запроса изменения статуса заказа на "продан".
        /// </summary>
        /// <param name="auth">
        ...
        public SetOrderSoldRequest(string auth, string sessionId, int cityId, int orderId)
        {
            Auth = auth;
            SessionId = sessionId;
            CityId = cityId;
