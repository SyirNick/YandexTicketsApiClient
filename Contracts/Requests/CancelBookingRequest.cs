...
{
    /// <summary>
    /// Класс запроса снятия предварительной брони билета.
    /// </summary>
    public class CancelBookingRequest : TicketOrderRequestBase
    {
        /// <summary>
        /// Конструктор класса запроса снятия предварительной брони билета.
        /// </summary>
        /// <param name="auth">
        ...
        public CancelBookingRequest(string auth, string sessionId, int cityId, int ticketId)
        { 
            Auth = auth;
            SessionId = sessionId;
            CityId = cityId;
