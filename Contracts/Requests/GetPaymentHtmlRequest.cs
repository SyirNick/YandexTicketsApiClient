...
{
    /// <summary>
    /// Класс запроса HTML-формы с кнопкой перехода на страницу оплаты.
    /// </summary>
    public class GetPaymentHtmlRequest : TicketOperationRequestBase
    {
        /// <summary>
        /// Конструктор класса запроса HTML-формы с кнопкой перехода на страницу оплаты.
        /// </summary>
        /// <param name="auth">
        ...
        public GetPaymentHtmlRequest(string auth, string sessionId, int cityId, int orderId)
        {
            Auth = auth;
            SessionId = sessionId;
            CityId = cityId;
